...
export const metadata: Metadata = {
  title: 'Our Work — Website Design & Development',
  description: 'See selected SiteCrafters work, including BCA Vault, a student resource portal built with a focus on clarity and usability.',
